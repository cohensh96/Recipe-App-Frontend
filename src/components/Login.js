...
const invalidLabelClass =
  ...
  return (
    <form className="flex h-full flex-col justify-evenly items-center" onSubmit={handleSubmit}>
    <label htmlFor="header" className="text-4xl uppercase font-bold">Sign in</label>
    ...
    <div className="text-right mb-10 w-full">
      ...
      <div className="persistCheck mt-3 flex justify-center items-end text-sm">
              <input 
                  ...
                  checked={persist}
              />
              <label className="m-0" htmlFor="persist">Trust this Device</label>
      </div>
      <button  
        type="submit"
        className="
